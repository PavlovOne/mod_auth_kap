...
command_rec kap_config_cmds[] = {
		...
		AP_INIT_TAKE1("KAPProviderMetadataURL", kap_set_string_slot,
				(void*)APR_OFFSETOF(kap_cfg, provider.metadata_url),
				RSRC_CONF,
				"OpenID Connect OP configuration metadata URL."),
		AP_INIT_TAKE1("KAPProviderIssuer", kap_set_string_slot,
		...
		AP_INIT_ITERATE("KAPPrivateKeyFiles", kap_set_private_key_files_enc,
				NULL,
				RSRC_CONF,
		...
		AP_INIT_TAKE1("KAPIDTokenEncryptedResponseAlg",
				kap_set_encrypted_response_alg,
		...
		AP_INIT_TAKE1("KAPIDTokenEncryptedResponseEnc",
				kap_set_encrypted_response_enc,
		...
		AP_INIT_TAKE1("KAPScope", kap_set_string_slot,
		...
		AP_INIT_TAKE1("KAPDefaultLoggedOutURL", kap_set_url_slot,
		...
		AP_INIT_TAKE1("KAPCookieDomain",
				kap_set_cookie_domain, NULL, RSRC_CONF,
		...
		AP_INIT_TAKE1("KAPClaimPrefix", kap_set_string_slot,
		...
		AP_INIT_TAKE1("KAPSessionInactivityTimeout",
				kap_set_session_inactivity_timeout,
		...
		AP_INIT_TAKE1("KAPCacheType", kap_set_cache_type,
				(void*)APR_OFFSETOF(kap_cfg, cache), RSRC_CONF,
				"Cache type; must be one of \"file\", \"memcache\" or \"shm\"."),

		AP_INIT_TAKE1("KAPCacheDir", kap_set_dir_slot,
		...
		AP_INIT_TAKE1("KAPCacheShmMax", kap_set_int_slot,
				(void*)APR_OFFSETOF(kap_cfg, cache_shm_size_max),
				RSRC_CONF,
				"Maximum number of cache entries to use for \"shm\" caching."),
		AP_INIT_TAKE1("KAPCacheShmEntrySizeMax", kap_set_cache_shm_entry_size_max,
		...
		AP_INIT_TAKE1("KAPAuthNHeader", ap_set_string_slot,
